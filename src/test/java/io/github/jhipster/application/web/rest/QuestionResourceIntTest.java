...
public class QuestionResourceIntTest {
    ...
    private static final Long DEFAULT_I_D_QUESTION = 1L;
    private static final Long UPDATED_I_D_QUESTION = 2L;
    ...
    public static Question createEntity(EntityManager em) {
        Question question = new Question()
            .iDQuestion(DEFAULT_I_D_QUESTION)
            .titre(DEFAULT_TITRE);
        return question;
    }
    ...
    public void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.getiDQuestion()).isEqualTo(DEFAULT_I_D_QUESTION);
    ...
    public void getAllQuestions() throws Exception {
        ...
        restQuestionMockMvc.perform(get("/api/questions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].iDQuestion").value(hasItem(DEFAULT_I_D_QUESTION.intValue())))
    ...
    public void getQuestion() throws Exception {
        ...
        restQuestionMockMvc.perform(get("/api/questions/{id}", question.getId()))
            ...
            .andExpect(jsonPath("$.iDQuestion").value(DEFAULT_I_D_QUESTION.intValue()))
    ...
    public void updateQuestion() throws Exception {
        ...
        updatedQuestion
            .iDQuestion(UPDATED_I_D_QUESTION)
            .titre(UPDATED_TITRE);
        ...
        Question testQuestion = questionList.get(questionList.size() - 1);
        assertThat(testQuestion.getiDQuestion()).isEqualTo(UPDATED_I_D_QUESTION);
