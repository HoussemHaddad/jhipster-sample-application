...
public class NotificationResourceIntTest {
    ...
    private static final Long DEFAULT_I_D_NOTIF = 1L;
    private static final Long UPDATED_I_D_NOTIF = 2L;
    ...
    public void createNotification() throws Exception {
        ...
        assertThat(testNotification.getiDNotif()).isEqualTo(DEFAULT_I_D_NOTIF);
    }
    ...
    public void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc.perform(get("/api/notifications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].iDNotif").value(hasItem(DEFAULT_I_D_NOTIF.intValue())));
    }
    ...
    public void getNotification() throws Exception {
        ...
        restNotificationMockMvc.perform(get("/api/notifications/{id}", notification.getId()))
            ...
            .andExpect(jsonPath("$.iDNotif").value(DEFAULT_I_D_NOTIF.intValue()));
    }
    ...
    public void updateNotification() throws Exception {
        ...
        Notification testNotification = notificationList.get(notificationList.size() - 1);
        assertThat(testNotification.getiDNotif()).isEqualTo(UPDATED_I_D_NOTIF);
    }
